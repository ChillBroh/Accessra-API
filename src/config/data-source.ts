...
const config: DataSourceOptions = migrationType === 'tenant' ? tenantOrmConfig : publicOrmConfig;
...
AppDataSource.initialize()
  .then(() => {
    console.log(`Data Source has been initialized for ${migrationType || 'public'} schema!`);
  })
  .catch((err) => {
